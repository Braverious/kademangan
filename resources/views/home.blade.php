...
<main>
    ...
    @php
        ...
        // Pastikan $setting ada, jika tidak langsung pakai default
        $sections = isset($setting) && $setting->section_order ? $setting->section_order : $defaultOrder;

        // Tambahan: Jika ternyata datanya masih berupa string (belum otomatis jadi array)
                ...
                <div class="container-fluid px-lg-5">
                    <div class="row mb-4">
                        <div class="col-12 text-center">
                            ...
                            <p class="text-muted">Berpengalaman melayani lingkungan pemerintahan & warga secara
                                transparan.</p>
                        </div>
                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                                <div class="card metric-card news-card h-100 overflow-hidden rounded-4 shadow-sm">
                                    <div class="card-body text-center d-flex flex-column">
                                        ...
                                        <p class="metric-desc text-muted mb-4">Data statistik wilayah Kademangan saat
                                            ini.</p>
                                        <div class="metric-value mt-auto fw-bold h3 text-primary">{{ $s['val'] }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container-fluid px-lg-5">
                    ...
                    <div id="carouselGaleri"
                        ...
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#carouselGaleri" data-bs-slide-to="0"
                            ...
                            <div class="col-md-4">
                                <div class="card news-card h-100 overflow-hidden rounded-4 shadow-sm">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <h5 class="card-title mb-2">Kegiatan Kerja Bakti Rutin Lingkungan Kademangan
                                        </h5>

                                        <p class="card-text small text-muted mb-3 flex-grow-1 home-news-excerpt">
                                            Ini adalah contoh teks ringkasan berita kelurahan. Warga diharapkan
                                            berpartisipasi
                                            dalam
