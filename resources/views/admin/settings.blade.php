                ...
                <form action="{{ route('admin.settings.footer.save') }}" method="post">
                    ...
                    <div class="card mb-3">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <button type="button" id="btnAddLink" class="btn btn-sm btn-primary">+ Tambah
                                Tautan</button>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <button type="button" id="btnAddSocial" class="btn btn-sm btn-primary">+ Tambah
                                Sosial</button>
                        </div>
                        <div class="card-body">
