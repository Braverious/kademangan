                    ...
                    <form action="{{ route('admin.settings.jabatan.update', $jabatan->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="is_active" class="form-control">
                                <option value="1" {{ old('is_active', (string) $jabatan->is_active) == '1' ? 'selected' : '' }}>Aktif</option>
                                <option value="0" {{ old('is_active', (string) $jabatan->is_active) == '0' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
                        </div>
