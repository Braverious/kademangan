                    ...
                    <form action="{{ route('admin.settings.runningtext.update') }}" method="POST" id="form-runningtext">
                        ...
                        <div class="setting-block">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-control form-select" name="top_direction" id="top_direction" required>
                                ...
                                <div class="col-md-7 mb-3">
                                    ...
                                    <textarea class="form-control" name="top_content" id="top_content" rows="2" maxlength="255" required placeholder="Tulis pengumuman...">{{ old('top_content', $top->content) }}</textarea>
                                </div>
                            </div>

                            <div class="mt-2">
                                <label class="text-muted font-weight-bold" style="font-size: 0.85rem; text-transform: uppercase;">Live Preview Display</label>
                        ...
                        <div class="setting-block mb-0">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <label class="form-label required">Arah Gerak</label>
                                    <select class="form-control form-select" name="bottom_direction" id="bottom_direction" required>
                                ...
                                <div class="col-md-7 mb-3">
                                    <label class="form-label required">Konten Teks</label>
                                    <textarea class="form-control" name="bottom_content" id="bottom_content" rows="2" maxlength="255" required placeholder="Tulis pengumuman...">{{ old('bottom_content', $bottom->content) }}</textarea>
                                </div>
                            </div>
