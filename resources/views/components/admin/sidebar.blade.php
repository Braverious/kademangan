        ...
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                $services = [
                    ...
                    ['slug' => 'surat_penghasilan',          'url' => 'admin/surat_penghasilan',          'label' => 'Surat Keterangan Penghasilan'],
                    ...
                    ['slug' => 'surat_pengantar_nikah',      'url' => 'admin/surat_pengantar_nikah',      'label' => 'Surat Pengantar Nikah'],
                ];
                ...
                @php
                $kontenItems = [
                    ['slug' => 'berita',     'url' => 'admin/berita',     'icon' => 'fas fa-newspaper', 'label' => 'Berita'],
                    ['slug' => 'galeri',     'url' => 'admin/galeri',     'icon' => 'far fa-images',    'label' => 'Galeri'],
                    ['slug' => 'pengumuman', 'url' => 'admin/pengumuman', 'icon' => 'fas fa-bullhorn',  'label' => 'Pengumuman'],
                ];
                ...
                @if (true) 
                    ...
                    <li class="nav-item {{ $isSettingsMenuActive ? 'active sub-menu' : '' }}">
                        <a data-toggle="collapse" href="#menuPengaturan" class="collapsed" aria-expanded="{{ $isSettingsMenuActive ? 'true' : 'false' }}">
